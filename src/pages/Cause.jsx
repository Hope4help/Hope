        ...
        <div className="container">
            ...
            <div className="row">
                ...
                <div className="wpo-case-item">
                    ...
                    <img src="/assets/images/case/img-1.png" alt="img-1" />
                    </div>
                ...
                <div className="wpo-case-item">
                    <div className="wpo-case-img">
                    <img src="/assets/images/case/img-2.png" alt="img-2" />
                    </div>
                    <div className="wpo-case-content">
                    <div className="wpo-case-text-top">
                ...
                <div className="wpo-case-item">
                    <div className="wpo-case-img">
                    <img src="/assets/images/case/img-3.png" alt="img-3" />
                    </div>
                    <div className="wpo-case-content">
                    <div className="wpo-case-text-top">
                ...
                <div className="wpo-case-item">
                    <div className="wpo-case-img">
                    <img src="/assets/images/case/img-4.png" alt="img-4" />
                    </div>
                    <div className="wpo-case-content">
                    <div className="wpo-case-text-top">
                ...
                <div className="wpo-case-item">
                    <div className="wpo-case-img">
                    <img src="/assets/images/case/img-5.png" alt="img-5" />
                    </div>
                    <div className="wpo-case-content">
                    <div className="wpo-case-text-top">
                ...
                <div className="wpo-case-item">
                    <div className="wpo-case-img">
                    <img src="/assets/images/case/img-6.png" alt="img-6" />
                    </div>
                    <div className="wpo-case-content">
                    <div className="wpo-case-text-top">
