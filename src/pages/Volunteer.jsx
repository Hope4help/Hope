...
//                   <div className="wpo-team-wrap">
//                     <div className="wpo-team-img">
//                       <img src="/src/assets/images/team/team-2.jpg" alt />
//                     </div>
//                     <div className="wpo-team-content">
//                       <div className="wpo-team-text-sub">
//                         <h2>Robert Honey</h2>
...
//                   <div className="wpo-team-wrap">
//                     <div className="wpo-team-img">
//                       <img src="/src/assets/images/team/team-3.jpg" alt />
//                     </div>
//                     <div className="wpo-team-content">
//                       <div className="wpo-team-text-sub">
//                         <h2>Juliya Jossoy</h2>
            ...
            <div className="row">
              <div className="col-12">
                <div className="volunteer-item">
                  <div className="volunteer-img-wrap">
                    <div className="volunter-img">
                      <img src="/src/assets/images/volunteer.jpg" alt="Volunteer" />
                    </div>
                  </div>
                </div>
                <div className="volunteer-contact">
          ...
          <div className="container">
            ...
            <div className="row">
              ...
              <div className="col-lg-4 col-md-4 col-sm-6 col-12 custom-grid">
                <div className="wpo-team-wrap">
                  <div className="wpo-team-img">
                    <img src="/src/assets/images/team/team-2.jpg" alt="Team Member" />
                  </div>
                  <div className="wpo-team-content">
                    <div className="wpo-team-text-sub">
                      <h2>Robert Honey</h2>
              ...
              <div className="col-lg-4 col-md-4 col-sm-6 col-12 custom-grid">
                <div className="wpo-team-wrap">
                  <div className="wpo-team-img">
                    <img src="/src/assets/images/team/team-3.jpg" alt="Team Member" />
                  </div>
                  <div className="wpo-team-content">
                    <div className="wpo-team-text-sub">
                      <h2>Juliya Jossoy</h2>
